...
namespace ANYU.Api.Migrations
{
    ...
    [Migration("20231217134800_TopicAndComment")]
    partial class TopicAndComment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ANYU.Api.Models.Comment", b =>
                {
            ...
            modelBuilder.Entity("ANYU.Api.Models.Topic", b =>
                {
                    b.Property<int>("TopicId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ANYU.Api.Models.Comment", b =>
                {
                    b.HasOne("ANYU.Api.Models.Topic", "Topic")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("ANYU.Api.Models.LectureLab", b =>
                {
                    ...
                    b.Navigation("UserLectureLabData");
                });
