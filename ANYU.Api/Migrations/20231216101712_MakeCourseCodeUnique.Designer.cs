...
namespace ANYU.Api.Migrations
{
    ...
    [Migration("20231216101712_MakeCourseCodeUnique")]
    partial class MakeCourseCodeUnique
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ANYU.Api.Models.UserCompletedRequirement", b =>
                {
                    ...
                    b.Property<int?>("UserCourseDataCourseInstanceId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserCourseDataUserId", "UserCourseDataCourseInstanceId");
            ...
            modelBuilder.Entity("ANYU.Api.Models.UserCompletedRequirement", b =>
                {
                    ...
                    b.HasOne("ANYU.Api.Models.UserCourseData", null)
                        .WithMany("CompletedRequirements")
                        .HasForeignKey("UserCourseDataUserId", "UserCourseDataCourseInstanceId");
